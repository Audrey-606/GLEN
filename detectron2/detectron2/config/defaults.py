...
# 在 _C.MODEL 下添加你的自定义配置项
_C.MODEL.LENGTH_ANNOTATION_TRAIN = CN()
_C.MODEL.LENGTH_ANNOTATION_TRAIN.PATH = ""  # 这里你可以设置自定义的路径

_C.MODEL.LENGTH_ANNOTATION_VAL = CN()
_C.MODEL.LENGTH_ANNOTATION_VAL.PATH = ""  # 同样，设置对应的路径
