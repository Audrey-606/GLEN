...
# 注解路径
ANN_ROOT = os.path.join(DATASET_ROOT, 'coco_seedling/annotations')
# print('ANN_ROOT' + ANN_ROOT)
TRAIN_PATH = os.path.join(DATASET_ROOT, 'coco_seedling/train2017')
VAL_PATH = os.path.join(DATASET_ROOT, 'coco_seedling/val2017')
